...
At this point of the preview, it is mandatory to install the AKS host management cluster on your Azure Stack HCI or Windows Server cluster. Follow this documentation to [install AKS host management cluster using PowerShell](https://github.com/MicrosoftDocs/azure-stack-docs/blob/main/azure-stack/aks-hci/kubernetes-walkthrough-powershell.md). We only support running the [August release](https://github.com/Azure/aks-hci/releases/tag/AKS-HCI-2208) of AKS host management cluster.
